...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class PlayerDestinationControllerBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (PlayerDestinationControllerNetworkObject)obj;
		...
		{
			Initialize(new PlayerDestinationControllerNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new PlayerDestinationControllerNetworkObject(networker, this, createCode, metadata);
		}
