...
{
	[GeneratedRPC("{\"types\":[[\"string\"][\"uint\", \"bool\", \"string\"]]")]
	[GeneratedRPCVariableNames("{\"types\":[[\"_factionOwner\"][\"_playerNetId\", \"_isCapturing\", \"_playerNickname\"]]")]
	public abstract partial class TowerEntityControllerBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (TowerEntityControllerNetworkObject)obj;
		...
		{
			Initialize(new TowerEntityControllerNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new TowerEntityControllerNetworkObject(networker, this, createCode, metadata);
		}
